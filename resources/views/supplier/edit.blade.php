            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3">
                            <div class="col-6">
                                <label for="name" class="form-label">Supplier name<spans class="text-danger">*</spans></label>
                            ...
                            <div class="col-6">
                                <label for="tolerance" class="form-label">Tolerance for PO<spans class="text-danger">*</spans></label>
                                <input type="text" class="form-control" id="torelance" name="tolerance">
                            </div>
                            <div class="col-6">
                                <label for="carrier" class="form-label">Carrier name<spans class="text-danger">*</spans></label>
                                <input type="carrier" class="form-control" id="email" name="carrier">
                            </div>
                            <div class="col-6">
                                <label for="service" class="form-label">Service name<spans class="text-danger">*</spans></label>
